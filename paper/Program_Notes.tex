...
\texttt{representational\_regress\_master\_extended} (abbrev \texttt{RepresentationalRegressMasterExtended}): extends the above with
\begin{enumerate}
...
\item Write the actual paper from \texttt{PAPER\_OUTLINE.tex}.
