...
| Route W (fallback) | `RepresentationalIncompleteness/CylinderMobiusNonhomeo.lean` | Steps **1–4** **done**; Step 5 optional (doubling vs injective cylinder composite); **not** main path to M-FINAL |
